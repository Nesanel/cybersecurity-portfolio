...
<p align="center">
  <img src="Figures/01-Environment/wazuh-dashboard.png" width="850">
</p>

<p align="center">
  <i>Figure 1. Wazuh Dashboard after successful deployment of the Home SOC environment.</i>
</p>
...
<p align="center">
  <img src="Figures/02-Installation/wazuh-login-ubuntu-server.png" width="900">
</p>

<p align="center">
  <i>Figure 2. Ubuntu server and Wazuh web interface accessible from the Windows host after deployment.</i>
</p>
...
<p align="center">
  <img src="Figures/02-Installation/windows-agent-install-command.png" width="900">
</p>

<p align="center">
  <i>Figure 3. Wazuh-generated Windows Agent installation command executed from an elevated PowerShell session.</i>
</p>
...
<p align="center">
  <img src="Figures/04-Validation/agent-active.png" width="850">
</p>

<p align="center">
  <i>Figure 4. Windows endpoint successfully enrolled and active in Wazuh.</i>
</p>
...
<p align="center">
  <img src="Figures/03-Configuration/ossec-conf-sysmon.png" width="850">
</p>

<p align="center">
  <i>Figure 5. Wazuh agent configuration showing the Sysmon Operational event channel being monitored.</i>
</p>
...
<p align="center">
<i>Figure 6. Sysmon service successfully installed and running on the Windows endpoint.</i>
</p>
...
<p align="center">
  <img src="Figures/04-Validation/sysmon-event-id-1-details.png" width="850">
</p>

<p align="center">
  <i>Figure 7. Sysmon Event ID 1 showing detailed process creation telemetry from the Windows endpoint.</i>
</p>
...
<p align="center">
  <img src="Figures/05-Detection/rule-92031-t1087.png" width="850">
</p>

<p align="center">
  <i>Figure 8. Wazuh detection for Rule 92031 mapped to MITRE ATT&CK T1087 Account Discovery.</i>
</p>
...
<p align="center">
  <img src="Figures/07-Troubleshooting/sysmon-ingestion-troubleshooting.png" width="900">
</p>

<p align="center">
  <i>Figure 9. Troubleshooting Sysmon ingestion by reviewing Wazuh logs, listener ports, and the Windows agent configuration.</i>
</p>
...
<p align="center">
  <img src="Figures/07-Troubleshooting/wazuh-vd-storage-root-cause.png" width="850">
</p>

<p align="center">
  <i>Figure 10. Root cause analysis showing <code>/var/ossec/queue/vd_updater</code> and <code>/var/ossec/queue/vd</code> consuming significant storage during Wazuh vulnerability database activity.</i>
</p>


<p align="center">
  <img src="Figures/08-Recovery/virtualbox-snapshot-recovery.png" width="850">
</p>

<p align="center">
  <i>Figure 11. VirtualBox snapshot tree used to recover the lab to a known-good state.</i>
</p>
